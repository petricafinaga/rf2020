...
public class FileUtils 
{
	...
	protected static String[][] readCsvSetFromFile(String fileName) throws USVInputFileCustomException
	{
		...
		//  convert ArrayList<ArrayList<String>> to string[][] for performance
	...
	private static ArrayList<String> convertLineToLearningSetRow(String line)
	{
		...
		ArrayList<String> learningSetRow = new ArrayList<String>(Arrays.asList(stringValues));

		return learningSetRow;
	}
	
	protected static void writeCsvSetToFile(String fileName, double[][] normalizedSet)
	{
