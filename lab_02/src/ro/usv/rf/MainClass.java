...
//		FileUtils.writeLearningSetToFile("out.csv", autoscaleLearningSet(learningSet));
		
	}
	
	private static double[][] autoscaleLearningSet (double[][] learningSet, double[] featuresAverage)
	{
